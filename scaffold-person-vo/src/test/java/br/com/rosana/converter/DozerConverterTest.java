...
import br.com.rosana.converter.mocks.MockPerson;
import br.com.rosana.data.model.Person;
import br.com.rosana.data.vo.PersonVO;

//para testar se o Dozer Converter está funcionando adequadamente (se após a conversão os dados permanecem os mesmos
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        //ele vai converter a entidade mocada em uma PersonVO e conferir se os dados estão de acordo
        Assert.assertEquals((long) Long.valueOf(0L), output.getId());
    ...
    public void parseEntityListToVOListTest() {
        ...
        Assert.assertEquals((long) Long.valueOf(0L), outputZero.getId());
        ...
        Assert.assertEquals((long) Long.valueOf(7L), outputSeven.getId());
        ...
        Assert.assertEquals((long) Long.valueOf(12L), outputTwelve.getId());
